...
import pandas as pd
from parsers import karriere_at, metajob_at, jobviertel_at
...
# Mapping: Nur erste PLZ pro Ort (zur Vermeidung von Mehrdeutigkeiten)
...
engines = st.multiselect("Suchmaschinen", ["karriere.at", "metajob.at", "jobviertel.at"], default=["karriere.at"])
